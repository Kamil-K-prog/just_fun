...
def Passports():
    user = current_user
    return render_template('back/admin.html', user=user, title='Паспорта')
...
def Admin_Bids():
    user = current_user
    return render_template('back/admin_bids.html', user=user, title='Сбор информации')
...
def Admin_Forms():
    user = current_user
    return render_template('back/admin_forms.html', user=user, title='Золотые знаки')
...
def Passport_View():
    user = current_user
    return render_template('back/passport_view.html', user=user, title='Паспорт')
...
def Form_Collection_of_Information():
    user = current_user
    return render_template('back/form_collection_of_information.html', user=user, title='Сбор информации')
...
def Golden_Badge():
    user = current_user
    return render_template('back/golden_badge.html', user=user, title='Золотой знак')
