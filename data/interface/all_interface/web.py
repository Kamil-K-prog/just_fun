...
from ...db.__all_models import User, Passport, PassportStatus, GoldenMarkApplication, Quiz, Video, Photo, Profrisk
from ..flask_wtf_forms import AdminAddForm, PassportForm, GoldenBadgeApplicationForm, WorkProtectionForm
